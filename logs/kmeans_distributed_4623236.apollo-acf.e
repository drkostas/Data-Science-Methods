...
+ cd /lustre/haven/proj/UTK0150/kgeorgio/kmeans
+ CONDA_BIN='~/anaconda3/envs/dse512_playground/bin/'
+ command='mpirun -n 20 ~/anaconda3/envs/dse512_playground/bin/python kmeans_distributed.py -k 5'
+ eval mpirun -n 20 '~/anaconda3/envs/dse512_playground/bin/python' kmeans_distributed.py -k 5
++ mpirun -n 20 /nics/b/home/kgeorgio/anaconda3/envs/dse512_playground/bin/python kmeans_distributed.py -k 5
--------------------------------------------------------------------------
There are not enough slots available in the system to satisfy the 20
slots that were requested by the application:

  /nics/b/home/kgeorgio/anaconda3/envs/dse512_playground/bin/python
