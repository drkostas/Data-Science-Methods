...
+ command='mpirun -n 5 ~/anaconda3/envs/dse512_playground/bin/python kmeans_distributed.py -k 5'
+ eval mpirun -n 5 '~/anaconda3/envs/dse512_playground/bin/python' kmeans_distributed.py -k 5
++ mpirun -n 5 /nics/b/home/kgeorgio/anaconda3/envs/dse512_playground/bin/python kmeans_distributed.py -k 5
--------------------------------------------------------------------------
